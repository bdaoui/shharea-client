...
const handleProfile = (e) =>{
    e.preventDefault();
    axios
        .post("https://mittens-buffalo.cyclic.app/user/profile", {userId, location, info})
...
const handleFriendship = async () => {
    ...
    try{
       const friendsResponse = await axios.post(`https://mittens-buffalo.cyclic.app/user/${id}/friends`, {userId})
